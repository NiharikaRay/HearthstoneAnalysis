...
def allManaCurve():
  ...
  while (i < 21): 
    ...
    if (minion != 0):
      ax.text(ind[i], minion + 0.15,  '%d'%int(minion),
  ...
  ax.set_yticks(np.arange(20,step=5))
  ...
  ax.set_title("Mech Mana Curve", fontsize=20, fontname='Calibri')
  ...
  #plt.show()
  plt.savefig('mechManaCurve.png', bbox_inches='tight', facecolor='#ffefd5')
